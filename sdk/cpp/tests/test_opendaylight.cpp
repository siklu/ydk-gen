...
TEST_CASE("ReadODL") {
  ...
  auto bgp_read =
      crud.read_config(provider.get_node_provider("xr"), *bgp_filter);
...
TEST_CASE("CreateODL") {
  ...
  //  afi_safi->config->afi_safi_name =
  //  openconfig_bgp_types::L3VPNIPV4UNICAST(); afi_safi->config->enabled =
  //  false; bgp->global->afi_safis->afi_safi.append(afi_safi);
