...
TEST_CASE("test_types_int8") {
  ...
  ydktest_sanity::Runner *r_2 =
      dynamic_cast<ydktest_sanity::Runner *>(r_read.get());
...
TEST_CASE("test_types_int16") {
  ...
  ydktest_sanity::Runner *r_2 =
      dynamic_cast<ydktest_sanity::Runner *>(r_read.get());
  REQUIRE(r_1->ytypes->built_in_t->number16 ==
          r_2->ytypes->built_in_t->number16);
}
...
TEST_CASE("test_types_int32") {
  ...
  ydktest_sanity::Runner *r_2 =
      dynamic_cast<ydktest_sanity::Runner *>(r_read.get());
  REQUIRE(r_1->ytypes->built_in_t->number32 ==
          r_2->ytypes->built_in_t->number32);
}
...
TEST_CASE("test_types_int64") {
  ...
  ydktest_sanity::Runner *r_2 =
      dynamic_cast<ydktest_sanity::Runner *>(r_read.get());
  REQUIRE(r_1->ytypes->built_in_t->number64 ==
          r_2->ytypes->built_in_t->number64);
}
...
TEST_CASE("test_types_uint8") {
  ...
  ydktest_sanity::Runner *r_2 =
      dynamic_cast<ydktest_sanity::Runner *>(r_read.get());
  REQUIRE(r_1->ytypes->built_in_t->u_number8 ==
          r_2->ytypes->built_in_t->u_number8);
}
...
TEST_CASE("test_types_uint16") {
  ...
  ydktest_sanity::Runner *r_2 =
      dynamic_cast<ydktest_sanity::Runner *>(r_read.get());
  REQUIRE(r_1->ytypes->built_in_t->u_number16 ==
          r_2->ytypes->built_in_t->u_number16);
}
...
TEST_CASE("test_types_uint32") {
  ...
  ydktest_sanity::Runner *r_2 =
      dynamic_cast<ydktest_sanity::Runner *>(r_read.get());
  REQUIRE(r_1->ytypes->built_in_t->u_number32 ==
          r_2->ytypes->built_in_t->u_number32);
}
...
TEST_CASE("test_types_uint64") {
  ...
  ydktest_sanity::Runner *r_2 =
      dynamic_cast<ydktest_sanity::Runner *>(r_read.get());
  REQUIRE(r_1->ytypes->built_in_t->u_number64 ==
          r_2->ytypes->built_in_t->u_number64);
}
...
TEST_CASE("test_types_bits") {
  ...
  ydktest_sanity::Runner *r_2 =
      dynamic_cast<ydktest_sanity::Runner *>(r_read.get());
  REQUIRE(r_1->ytypes->built_in_t->bits_value ==
          r_2->ytypes->built_in_t->bits_value);
}
...
TEST_CASE("test_types_bool") {
  ...
  REQUIRE(r_1->ytypes->built_in_t->bool_value ==
          r_2->ytypes->built_in_t->bool_value);
}
...
TEST_CASE("test_types_embeded_enum") {
  ...
  // CREATE
  r_1->ytypes->built_in_t->embeded_enum =
      ydktest_sanity::Runner::Ytypes::BuiltInT::EmbededEnum::seven;
  reply = crud.create(provider, *r_1);
  REQUIRE(reply);
  ...
  ydktest_sanity::Runner *r_2 =
      dynamic_cast<ydktest_sanity::Runner *>(r_read.get());
  REQUIRE(r_1->ytypes->built_in_t->embeded_enum ==
          r_2->ytypes->built_in_t->embeded_enum);
  auto embeded_enum_name = r_2->ytypes->built_in_t->embeded_enum;
  auto embeded_enum_value =
      ydktest_sanity::Runner::Ytypes::BuiltInT::EmbededEnum::get_enum_value(
          embeded_enum_name);
  REQUIRE(r_1->ytypes->built_in_t->embeded_enum.enum_value ==
          embeded_enum_value);
...
TEST_CASE("test_types_enum") {
  ...
  ydktest_sanity::Runner *r_2 =
      dynamic_cast<ydktest_sanity::Runner *>(r_read.get());
  REQUIRE(r_1->ytypes->built_in_t->enum_value ==
          r_2->ytypes->built_in_t->enum_value);
}
...
TEST_CASE("test_types_identity") {
  ...
  auto r_2 =
      dynamic_cast<ydktest_sanity::Runner::Ytypes::BuiltInT *>(r_read.get());
...
TEST_CASE("test_types_submodule") {
  ...
  auto r_read = crud.read(provider, *filter);
  REQUIRE(r_read != nullptr);
  ydktest_sanity::SubTest *r_2 =
      dynamic_cast<ydktest_sanity::SubTest *>(r_read.get());
...
TEST_CASE("test_types_identity_other_module") {
  ...
  // CREATE
  r_1->ytypes->built_in_t->identity_ref_value =
      ydktest_sanity_types::YdktestType();
  reply = crud.create(provider, *r_1);
  REQUIRE(reply);
  ...
  ydktest_sanity::Runner *r_2 =
      dynamic_cast<ydktest_sanity::Runner *>(r_read.get());
  REQUIRE(r_1->ytypes->built_in_t->identity_ref_value ==
          r_2->ytypes->built_in_t->identity_ref_value);
}
...
TEST_CASE("test_types_enum_leaflist") {
  ...
  // CREATE
  r_1->ytypes->built_in_t->enum_llist.append(
      ydktest_sanity::YdkEnumTest::local);
  r_1->ytypes->built_in_t->enum_llist.append(
      ydktest_sanity::YdkEnumTest::remote);
  reply = crud.create(provider, *r_1);
  REQUIRE(reply);
  ...
  // TODO. Issue #944 (No way to retrieve numeric value of enums in cpp
  // generated code)
  //    for (auto test : r_2->ytypes->built_in_t->enum_llist.values) {
  //    	if (test.name == ydktest_sanity::YdkEnumTest::local.name)
  //            cout << "Name: " << test.name << ", Int value: " <<
  //            ydktest_sanity::YdkEnumTest::local.value << endl;
  //    	else
  //    	    cout << "Name: " << test.name << ", Int value: " <<
  //    ydktest_sanity::YdkEnumTest::remote.value << endl;
  //    }
}
...
TEST_CASE("test_types_identity_leaflist") {
  ...
  // CREATE
  r_1->ytypes->built_in_t->identity_llist.append(
      ydktest_sanity::ChildIdentity());
  r_1->ytypes->built_in_t->identity_llist.append(
      ydktest_sanity::ChildChildIdentity());
  reply = crud.create(provider, *r_1);
  REQUIRE(reply);
  ...
  ydktest_sanity::Runner *r_2 =
      dynamic_cast<ydktest_sanity::Runner *>(r_read.get());
  REQUIRE(r_1->ytypes->built_in_t->enum_llist ==
          r_2->ytypes->built_in_t->enum_llist);
}
...
TEST_CASE("test_types_union_complex_list") {
  ...
  ydktest_sanity::Runner *r_2 =
      dynamic_cast<ydktest_sanity::Runner *>(r_read.get());
  REQUIRE(r_1->ytypes->built_in_t->younion_list ==
          r_2->ytypes->built_in_t->younion_list);
}
...
TEST_CASE("test_types_bits_list") {
  ...
  //  ydktest_sanity::Runner * r_2 =
  //  dynamic_cast<ydktest_sanity::Runner*>(r_read.get());
  //  REQUIRE(r_1->ytypes->built_in_t->bits_llist ==
  //  r_2->ytypes->built_in_t->bits_llist);
}
...
TEST_CASE("test_cascading_types") {
  ...
  ydktest_sanity::CascadingTypes *ctypesRead =
      dynamic_cast<ydktest_sanity::CascadingTypes *>(temp.get());
...
TEST_CASE("test_capital_letters") {
  ...
  // CREATE
  auto gigabit_eth =
      make_shared<ydktest_sanity::Native::Interface::GigabitEthernet>();
  ...
  ydktest_sanity::Native *read_entity =
      dynamic_cast<ydktest_sanity::Native *>(read_entity_wrapper.get());
...
TEST_CASE("test_ylist_two_keys") {
  ...
  auto l1 = make_shared<ydktest_sanity::Runner::TwoKeyList>();
  l1->first = "f1";
  l1->second = 11;
  auto l2 = make_shared<ydktest_sanity::Runner::TwoKeyList>();
  l2->first = "f2";
  l2->second = 22;
...
TEST_CASE("test_ylist_no_keys") {
  ...
  auto t1 = make_shared<ydktest_sanity::Runner::NoKeyList>();
  t1->test = "t1";
  auto t2 = make_shared<ydktest_sanity::Runner::NoKeyList>();
  t2->test = "t2";
  auto t3 = make_shared<ydktest_sanity::Runner::NoKeyList>();
  t3->test = "t3";
  ...
  auto runner_decoded = codec_service.decode(
      codec_provider, json, std::make_unique<ydktest_sanity::Runner>());
