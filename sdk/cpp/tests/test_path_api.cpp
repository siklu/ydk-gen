...
const char* expected_bgp_read =
    "<bgp "
    "xmlns=\"http://openconfig.net/yang/bgp\"><global><config><as>65172</as></"
    "config><use-multiple-paths><state><enabled>false</enabled></"
    "state><ebgp><state><allow-multiple-as>false</"
    "allow-multiple-as><maximum-paths>1</maximum-paths></state></"
    "ebgp><ibgp><state><maximum-paths>1</maximum-paths></state></ibgp></"
    "use-multiple-paths><route-selection-options><state><always-compare-med>"
    "false</always-compare-med><ignore-as-path-length>false</"
    "ignore-as-path-length><external-compare-router-id>true</"
    "external-compare-router-id><advertise-inactive-routes>false</"
    "advertise-inactive-routes><enable-aigp>false</"
    "enable-aigp><ignore-next-hop-igp-metric>false</"
    "ignore-next-hop-igp-metric></state></"
    "route-selection-options><afi-safis><afi-safi><afi-safi-name "
    "xmlns:oc-bgp-types=\"http://openconfig.net/yang/"
    "bgp-types\">oc-bgp-types:L3VPN_IPV4_UNICAST</"
    "afi-safi-name><config><afi-safi-name "
    "xmlns:oc-bgp-types=\"http://openconfig.net/yang/"
    "bgp-types\">oc-bgp-types:L3VPN_IPV4_UNICAST</afi-safi-name><enabled>true</"
    "enabled></config><state><enabled>false</enabled></"
    "state><graceful-restart><state><enabled>false</enabled></state></"
    "graceful-restart><route-selection-options><state><always-compare-med>"
    "false</always-compare-med><ignore-as-path-length>false</"
    "ignore-as-path-length><external-compare-router-id>true</"
    "external-compare-router-id><advertise-inactive-routes>false</"
    "advertise-inactive-routes><enable-aigp>false</"
    "enable-aigp><ignore-next-hop-igp-metric>false</"
    "ignore-next-hop-igp-metric></state></"
    "route-selection-options><use-multiple-paths><state><enabled>false</"
    "enabled></state><ebgp><state><allow-multiple-as>false</"
    "allow-multiple-as><maximum-paths>1</maximum-paths></state></"
    "ebgp><ibgp><state><maximum-paths>1</maximum-paths></state></ibgp></"
    "use-multiple-paths><apply-policy><state><default-import-policy>REJECT_"
    "ROUTE</default-import-policy><default-export-policy>REJECT_ROUTE</"
    "default-export-policy></state></apply-policy></afi-safi></"
    "afi-safis><apply-policy><state><default-import-policy>REJECT_ROUTE</"
    "default-import-policy><default-export-policy>REJECT_ROUTE</"
    "default-export-policy></state></apply-policy></"
    "global><neighbors><neighbor><neighbor-address>172.16.255.2</"
    "neighbor-address><config><neighbor-address>172.16.255.2</"
    "neighbor-address><peer-as>65172</peer-as></config><state><enabled>true</"
    "enabled><route-flap-damping>false</"
    "route-flap-damping><send-community>NONE</send-community></"
    "state><timers><state><connect-retry>30.0</connect-retry><hold-time>90.0</"
    "hold-time><keepalive-interval>30.0</"
    "keepalive-interval><minimum-advertisement-interval>30.0</"
    "minimum-advertisement-interval></state></"
    "timers><transport><state><mtu-discovery>false</"
    "mtu-discovery><passive-mode>false</passive-mode></state></"
    "transport><error-handling><state><treat-as-withdraw>false</"
    "treat-as-withdraw></state></"
    "error-handling><logging-options><state><log-neighbor-state-changes>true</"
    "log-neighbor-state-changes></state></"
    "logging-options><ebgp-multihop><state><enabled>false</enabled></state></"
    "ebgp-multihop><route-reflector><state><route-reflector-client>false</"
    "route-reflector-client></state></"
    "route-reflector><as-path-options><state><allow-own-as>0</"
    "allow-own-as><replace-peer-as>false</replace-peer-as></state></"
    "as-path-options><add-paths><state><receive>false</receive></state></"
    "add-paths><use-multiple-paths><state><enabled>false</enabled></"
    "state><ebgp><state><allow-multiple-as>false</allow-multiple-as></state></"
    "ebgp></"
    "use-multiple-paths><apply-policy><state><default-import-policy>REJECT_"
    "ROUTE</default-import-policy><default-export-policy>REJECT_ROUTE</"
    "default-export-policy></state></"
    "apply-policy><afi-safis><afi-safi><afi-safi-name "
    "xmlns:oc-bgp-types=\"http://openconfig.net/yang/"
    "bgp-types\">oc-bgp-types:L3VPN_IPV4_UNICAST</"
    "afi-safi-name><config><afi-safi-name "
    "xmlns:oc-bgp-types=\"http://openconfig.net/yang/"
    ...
    "enabled></config><state><enabled>false</enabled></"
    "state><graceful-restart><state><enabled>false</enabled></state></"
    "graceful-restart><apply-policy><state><default-import-policy>REJECT_ROUTE<"
    "/default-import-policy><default-export-policy>REJECT_ROUTE</"
    "default-export-policy></state></"
    "apply-policy><use-multiple-paths><state><enabled>false</enabled></"
    "state><ebgp><state><allow-multiple-as>false</allow-multiple-as></state></"
    "ebgp></use-multiple-paths></afi-safi></afi-safis></neighbor></neighbors></"
    "bgp>";
...
TEST_CASE("rpc_escape") {
  ...
  std::shared_ptr<ydk::path::Rpc> get_rpc{
      root.create_rpc("ietf-netconf-monitoring:get-schema")};
...
TEST_CASE("bgp_netconf_create") {
  ...
  auto& l3vpn_ipv4_unicast = bgp.create_datanode(
      "global/afi-safis/"
      "afi-safi[afi-safi-name='openconfig-bgp-types:L3VPN_IPV4_UNICAST']",
      "");

  auto& afi_safi_name = l3vpn_ipv4_unicast.create_datanode(
      "config/afi-safi-name", "openconfig-bgp-types:L3VPN_IPV4_UNICAST");

  // set the enable flag
  auto& enable = l3vpn_ipv4_unicast.create_datanode("config/enabled", "true");

  // bgp/neighbors/neighbor
  auto& neighbor = bgp.create_datanode(
      "neighbors/neighbor[neighbor-address='172.16.255.2']", "");

  auto& neighbor_address =
  ...
  auto& neighbor_af = neighbor.create_datanode(
      "afi-safis/"
      "afi-safi[afi-safi-name='openconfig-bgp-types:L3VPN_IPV4_UNICAST']",
      "");

  auto& neighbor_afi_safi_name = neighbor_af.create_datanode(
      "config/afi-safi-name", "openconfig-bgp-types:L3VPN_IPV4_UNICAST");

  auto& neighbor_enabled =
...
TEST_CASE("bits") {
  ...
  auto& ysanity =
      runner.create_datanode("ytypes/built-in-t/bits-value", "disable-nagle");
...
TEST_CASE("get_schema") {
  ...
  std::shared_ptr<ydk::path::Rpc> get_schema_rpc{
      schema.create_rpc("ietf-netconf-monitoring:get-schema")};
  get_schema_rpc->get_input_node().create_datanode("identifier",
                                                   "ydktest-sanity");
...
TEST_CASE("get_config") {
  ...
  std::shared_ptr<ydk::path::Rpc> get_schema_rpc{
      schema.create_rpc("ietf-netconf:get-config")};
  get_schema_rpc->get_input_node().create_datanode("source/candidate");
  get_schema_rpc->get_input_node().create_datanode(
      "filter", "<bgp xmlns=\"xmlns=http://openconfig.net/yang/bgp\"/>");
...
TEST_CASE("bgp_xr_openconfig") {
  ...
  auto& bgp = schema.create_datanode("openconfig-bgp:bgp", "");
  // get the root
  const ydk::path::DataNode* data_root =
      reinterpret_cast<const ydk::path::DataNode*>(&bgp.get_root());
  ...
  auto& ppeer_group =
      bgp.create_datanode("peer-groups/peer-group[peer-group-name='IBGP']", "");
  auto& peer_group_name =
...
//    ydk::path::Repository repo{};
//
//    ydk::path::NetconfSession session{repo,"localhost", "admin", "admin",
//    1220}; ydk::path::RootSchemaNode& schema = session.get_root_schema();
//
//    ydk::path::Codec s{};
//
...
//
//    auto & four_instance_as =
//    instance_as->create_datanode("four-byte-as[as='65172']");
//
//    auto & vrf =
//    four_instance_as->create_datanode("vrfs/vrf[vrf-name='red']");
//
//  std::shared_ptr<ydk::path::Rpc> create_rpc { schema.create_rpc("ydk:create")
//  }; auto xml = s.encode(bgp, ydk::EncodingFormat::XML, false); REQUIRE(
//  !xml.empty() ); create_rpc->get_input_node().create_datanode("entity", xml);
//
//  auto res = (*create_rpc)(session);
//
//  //call read
//    std::shared_ptr<ydk::path::Rpc> read_rpc { schema.create_rpc("ydk:read")
//    }; auto & bgp_read =
//    schema.create_datanode("Cisco-IOS-XR-ipv4-bgp-cfg:bgp", "");
//    std::shared_ptr<const ydk::path::DataNode>
//    data_root2{&bgp_read.get_root()};
//
//    xml = s.encode(bgp_read, ydk::EncodingFormat::XML, false);
//    REQUIRE( !xml.empty() );
//    read_rpc->get_input_node().create_datanode("filter", xml);
...
TEST_CASE("oc_interface") {
  ...
  runner.create_datanode("interface[name='GigabitEthernet0/0/0/2']/config/name",
                         "GigabitEthernet0/0/0/2");
  runner.create_datanode("interface[name='GigabitEthernet0/0/0/2']/config/type",
...
TEST_CASE("oc_routing") {
  ...
  auto& runner =
      schema.create_datanode("openconfig-routing-policy:routing-policy", "");

  runner.create_datanode(
      "defined-sets/openconfig-bgp-policy:bgp-defined-sets/community-sets/"
      "community-set[community-set-name='COMMUNITY-SET2']/config/"
      "community-set-name",
      "COMMUNITY-SET2");
  runner.create_datanode(
      "defined-sets/openconfig-bgp-policy:bgp-defined-sets/community-sets/"
...
TEST_CASE("action_create") {
  ...
  // run test knowing confd will reject action because it is not implemented on
  // device
...
{
    ydk::path::Repository repo{TEST_HOME};
    ydk::path::NetconfSession session{repo, "127.0.0.1", "admin", "admin",
12022}; ydk::path::RootSchemaNode& schema = session.get_root_schema();

    auto & runner = schema.create_datanode("openconfig-platform:components",
"");

    runner.create_datanode("component[name='0/0-OpticalChannel0/0/0/19']/openconfig-terminal-device:optical-channel/config/frequency",
"191600000");
    runner.create_datanode("component[name='0/0-OpticalChannel0/0/0/19']/openconfig-terminal-device:optical-channel/config/line-port",
"0/0-Optics0/0/0/19");
    runner.create_datanode("component[name='0/0-OpticalChannel0/0/0/19']/openconfig-terminal-device:optical-channel/config/operational-mode",
"2");
    runner.create_datanode("component[name='0/0-OpticalChannel0/0/0/19']/openconfig-terminal-device:optical-channel/config/target-output-power",
"100");
...
TEST_CASE("decode_encode_interfaces_with_filters") {
  ...
  auto ifc =
      make_shared<ydktest::openconfig_interfaces::Interfaces::Interface>();
  ifc->name = "Loopback10";
  ...
  auto top_entity =
      std::make_shared<ydktest::openconfig_interfaces::Interfaces>();
...
TEST_CASE("iana_if_type_decode") {
  ...
  auto root_data_node =
      codec.decode(root, ifc_payload, ydk::EncodingFormat::XML);
