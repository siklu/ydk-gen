...
void show_usage(string name) {
  cerr << "\nUsage:\n\t" << name
       << " [http|ssh]://user:password@host[:port] [-v]" << endl;
  cerr << "\t\tIf host is IPv6, enclose it in square brackets. E.g. "
          "[1234:1234:1234:1234::1234]"
       << endl;
  cerr << "\t\tIf port is not specified, 830 will be used with ssh (netconf) "
          "or 80 with http (restconf)"
       << endl
       << endl;
}
