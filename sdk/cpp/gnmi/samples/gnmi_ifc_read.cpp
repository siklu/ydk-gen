...
int main(int argc, char* argv[]) {
  ...
  auto ifc = make_shared<Cisco_IOS_XR_ifmgr_cfg::InterfaceConfigurations::
  ...
  auto ifc_filter =
      make_unique<Cisco_IOS_XR_ifmgr_cfg::InterfaceConfigurations>();
