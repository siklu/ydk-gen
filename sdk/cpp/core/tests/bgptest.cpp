...
const char* expected_bgp_peer_xml =
    ...
    "config><afi-safis><afi-safi><afi-safi-name "
    ...
    "enabled></config></afi-safi></afi-safis></"
    "global><peer-groups><peer-group><peer-group-name>IBGP</"
    "peer-group-name><config><peer-group-name>IBGP</"
    "peer-group-name><peer-as>65001</peer-as></"
    "config><afi-safis><afi-safi><afi-safi-name "
    "xmlns:oc-bgp-types=\"http://openconfig.net/yang/"
    "bgp-types\">oc-bgp-types:L3VPN_IPV4_UNICAST</"
    "afi-safi-name><config><afi-safi-name "
    "xmlns:oc-bgp-types=\"http://openconfig.net/yang/"
    "bgp-types\">oc-bgp-types:L3VPN_IPV4_UNICAST</afi-safi-name><enabled>true</"
    "enabled></config><apply-policy><config><export-policy>POLICY2</"
    "export-policy></config></apply-policy></afi-safi></afi-safis></"
    "peer-group></"
    "peer-groups><neighbors><neighbor><neighbor-address>172.16.255.2</"
    "neighbor-address><config><neighbor-address>172.16.255.2</"
    "neighbor-address><peer-group>IBGP</peer-group></config></neighbor></"
    "neighbors></bgp>";
const char* expected_bgp_peer_json =
    "{\"openconfig-bgp:bgp\":{\"global\":{\"config\":{\"as\":65172},\"afi-"
    "safis\":{\"afi-safi\":[{\"afi-safi-name\":\"openconfig-bgp-types:L3VPN_"
    "IPV4_UNICAST\",\"config\":{\"afi-safi-name\":\"openconfig-bgp-types:L3VPN_"
    "IPV4_UNICAST\",\"enabled\":true}}]}},\"peer-groups\":{\"peer-group\":[{"
    "\"peer-group-name\":\"IBGP\",\"config\":{\"peer-group-name\":\"IBGP\","
    "\"peer-as\":65001},\"afi-safis\":{\"afi-safi\":[{\"afi-safi-name\":"
    "\"openconfig-bgp-types:L3VPN_IPV4_UNICAST\",\"config\":{\"afi-safi-name\":"
    "\"openconfig-bgp-types:L3VPN_IPV4_UNICAST\",\"enabled\":true},\"apply-"
    "policy\":{\"config\":{\"export-policy\":[\"POLICY2\"]}}}]}}]},"
    "\"neighbors\":{\"neighbor\":[{\"neighbor-address\":\"172.16.255.2\","
    "\"config\":{\"neighbor-address\":\"172.16.255.2\",\"peer-group\":\"IBGP\"}"
    "}]}}}";
...
TEST_CASE("bgp_validation") {
  ...
  auto& neighbor_remove_as = neighbor.create_datanode(
      "config/remove-private-as", "openconfig-bgp-types:PRIVATE_AS_REMOVE_ALL");
  ...
  auto& peer_group_name =
      peer_group.create_datanode("config/peer-group-name", "IBGP");
...
TEST_CASE("decode_remove_as") {
  ...
  auto xml =
      "<bgp "
      "xmlns=\"http://openconfig.net/yang/"
      "bgp\"><neighbors><neighbor><neighbor-address>1.2.3.4</"
      "neighbor-address><config><neighbor-address>1.2.3.4</"
      "neighbor-address><remove-private-as "
      "xmlns:oc-bgp-types=\"http://openconfig.net/yang/"
      "bgp-types\">oc-bgp-types:PRIVATE_AS_REMOVE_ALL</remove-private-as></"
      "config></neighbor></neighbors></bgp>";
...
TEST_CASE("bits_order") {
  ...
  auto& bits = runner.create_datanode("ytypes/built-in-t/bits-value",
                                      "auto-sense-speed disable-nagle");
...
TEST_CASE("submodule") {  // TODO fix issue with submodule
                          // ydk::path::Repository repo{TEST_HOME};
  ...
  //
  //    //get the root
  //    std::unique_ptr<const ydk::path::DataNode>
  //    data_root{subtest->get_root()};
  //
  //    REQUIRE( data_root != nullptr );
  //
  //    auto name =
  //    subtest->create_datanode("ydktest-sanity:sub-test/one-aug/name",
  //    "test"); REQUIRE( name!= nullptr );
  //
  //    auto number =
  //    subtest->create_datanode("ydktest-sanity:sub-test/one-aug/number", "3");
  //    REQUIRE( number!= nullptr );

  //    auto ne1w_xml = s.encode(*subtest, ydk::EncodingFormat::XML, false);

  //    auto expected = "<sub-test
  //    xmlns=\"http://cisco.com/ns/yang/ydktest-sanity\"><one-aug><name>test</name></one-aug><one-aug><number>3</number></one-aug></sub-test>";
  ////    REQUIRE( new_xml == expected );
  //
