...
// the queue is full)
inline void spdlog::details::async_log_helper::log(
...
inline void spdlog::details::async_log_helper::set_formatter(
    formatter_ptr msg_formatter) {
...
inline void spdlog::details::async_log_helper::sleep_or_yield(
  ...
  if (time_since_op <= milliseconds(200)) return sleep_for(milliseconds(20));
