...
void YLeaf::set(uint8 val) { YLeaf::operator=(val); }

void YLeaf::set(uint32 val) { YLeaf::operator=(val); }

void YLeaf::set(uint64 val) { YLeaf::operator=(val); }

void YLeaf::set(long val) { YLeaf::operator=(val); }

void YLeaf::set(int8 val) { YLeaf::operator=(val); }

void YLeaf::set(int32 val) { YLeaf::operator=(val); }

void YLeaf::set(Enum::YLeaf val) { YLeaf::operator=(val); }

void YLeaf::set(Bits val) { YLeaf::operator=(val); }

void YLeaf::set(int64 val) { YLeaf::operator=(val); }

void YLeaf::set(double val) { YLeaf::operator=(val); }

void YLeaf::set(Empty val) { YLeaf::operator=(val); }

void YLeaf::set(Identity val) { YLeaf::operator=(val); }

void YLeaf::set(std::string val) { YLeaf::operator=(val); }

void YLeaf::set(Decimal64 val) { YLeaf::operator=(val); }
...
YLeaf::operator std::string() const { return get(); }

bool YLeaf::operator==(YLeaf& other) const { return get() == other.get(); }
