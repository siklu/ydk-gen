...
typedef struct RpcWrapper {
  RpcWrapper(shared_ptr<ydk::path::Rpc> rpc) : priv(rpc) {}

  shared_ptr<ydk::path::Rpc> priv;
} RpcWrapper;

typedef struct DataNodeWrapper {
  DataNodeWrapper(shared_ptr<ydk::path::DataNode> data) : priv(data) {}
...
static RootSchemaNodeWrapper* wrap(ydk::path::RootSchemaNode* node) {
  return (
      new RootSchemaNodeWrapper(shared_ptr<ydk::path::RootSchemaNode>(node)));
}
  ...
  try {
    ...
    for (int i = 0; i < size; i++) {
      ydk::path::Capability cap =
          *static_cast<ydk::path::Capability*>(values[i]);
      lookup_tables.insert(make_pair(keys[i], cap));
    }

    ydk::path::Repository* real_repo =
        static_cast<ydk::path::Repository*>(repo);
    std::shared_ptr<ydk::path::RootSchemaNode> schema_node =
        real_repo->create_root_schema(lookup_tables, real_caps);
...
const char* ServiceProviderType(ServiceProvider provider) {
  ydk::ServiceProvider* real_provider =
      static_cast<ydk::ServiceProvider*>(provider);
...
ServiceProvider NetconfServiceProviderInit(YDKStatePtr state,
  ...
  try {
    ydk::NetconfServiceProvider* real_provider =
        new ydk::NetconfServiceProvider(address, username, password, port,
                                        protocol);
...
ServiceProvider NetconfServiceProviderInitWithRepo(
  ...
  try {
    ydk::path::Repository* real_repo =
        static_cast<ydk::path::Repository*>(repo);
    ydk::NetconfServiceProvider* real_provider =
        new ydk::NetconfServiceProvider(*real_repo, address, username, password,
                                        port, protocol);
    return static_cast<void*>(real_provider);
  } catch (...) {
    YDKState* real_state = static_cast<YDKState*>(state);
...
void NetconfServiceProviderFree(ServiceProvider provider) {
  ydk::NetconfServiceProvider* real_provider =
      static_cast<ydk::NetconfServiceProvider*>(provider);
...
const char* NetconfServiceProviderGetCapabilityByIndex(ServiceProvider provider,
                                                       int index) {
  ydk::NetconfServiceProvider* real_provider =
      static_cast<ydk::NetconfServiceProvider*>(provider);
  if (real_provider != NULL) {
...
ServiceProvider RestconfServiceProviderInitWithRepo(
  ...
  try {
    ...
    ydk::RestconfServiceProvider* real_provider =
        new ydk::RestconfServiceProvider(*real_repo, address, username,
                                         password, port, real_encoding,
...
void RestconfServiceProviderFree(ServiceProvider provider) {
  ydk::RestconfServiceProvider* real_provider =
      static_cast<ydk::RestconfServiceProvider*>(provider);
  if (real_provider != NULL) {
    delete real_provider;
  }
}
...
OpenDaylightServiceProvider OpenDaylightServiceProviderInitWithRepo(
  ...
  try {
    ...
    ydk::OpenDaylightServiceProvider* real_provider =
        new ydk::OpenDaylightServiceProvider(*real_repo, address, username,
                                             password, port, real_encoding,
                                             real_protocol);
    return static_cast<void*>(real_provider);
  } catch (...) {
...
void OpenDaylightServiceProviderFree(OpenDaylightServiceProvider provider) {
  ydk::OpenDaylightServiceProvider* real_provider =
      static_cast<ydk::OpenDaylightServiceProvider*>(provider);
  if (real_provider != NULL) {
    delete real_provider;
  }
}
...
ServiceProvider OpenDaylightServiceProviderGetNodeProvider(
  ...
  try {
    ydk::OpenDaylightServiceProvider* real_provider =
        static_cast<ydk::OpenDaylightServiceProvider*>(provider);
    ydk::ServiceProvider* node_provider =
        &real_provider->get_node_provider(string(node_id));
...
RootSchemaNode ServiceProviderGetRootSchema(YDKStatePtr state,
                                            ServiceProvider provider) {
  try {
    ydk::ServiceProvider* real_provider =
        static_cast<ydk::ServiceProvider*>(provider);
    ydk::path::RootSchemaNode* root_schema =
        &real_provider->get_session().get_root_schema();
...
RootSchemaWrapper ServiceProviderGetRootSchemaNode(YDKStatePtr state,
                                                   ServiceProvider provider) {
  try {
    ydk::ServiceProvider* real_provider =
        static_cast<ydk::ServiceProvider*>(provider);
...
Session ServiceProviderGetSession(ServiceProvider provider) {
  ydk::ServiceProvider* real_provider =
      static_cast<ydk::ServiceProvider*>(provider);
  ydk::path::Session& s =
      const_cast<ydk::path::Session&>(real_provider->get_session());
  return static_cast<void*>(&s);
}

RootSchemaNode SessionGetRootSchema(YDKStatePtr state, Session session) {
  try {
    ydk::path::Session* real_session =
        static_cast<ydk::path::Session*>(session);
...
const char* CodecEncode(YDKStatePtr state, Codec codec, DataNode datanode,
                        EncodingFormat encoding, boolean pretty) {
  try {
    ydk::path::Codec* real_codec = (ydk::path::Codec*)codec;
    ...
    std::string payload =
        real_codec->encode(*real_datanode, get_real_encoding(encoding), pretty);
...
DataNode CodecDecode(YDKStatePtr state, Codec codec, RootSchemaNode root_schema,
                     const char* payload, EncodingFormat encoding) {
  try {
    ydk::path::Codec* real_codec = (ydk::path::Codec*)codec;
    ydk::path::RootSchemaNode* real_root_schema =
        (ydk::path::RootSchemaNode*)root_schema;
    shared_ptr<ydk::path::DataNode> datanode = real_codec->decode(
        *real_root_schema, payload, get_real_encoding(encoding));
...
DataNode RootSchemaNodeCreate(YDKStatePtr state, RootSchemaNode root_schema,
                              const char* path) {
  try {
    ydk::path::RootSchemaNode* real_root_schema =
        (ydk::path::RootSchemaNode*)root_schema;
...
Rpc RootSchemaNodeRpc(YDKStatePtr state, RootSchemaNode root_schema,
                      const char* path) {
  try {
    ydk::path::RootSchemaNode* real_root_schema =
        (ydk::path::RootSchemaNode*)root_schema;
...
DataNode RpcExecute(YDKStatePtr state, Rpc rpc, ServiceProvider provider) {
  try {
    ...
    std::shared_ptr<ydk::path::DataNode> result =
        (*real_rpc)((*real_provider).get_session());
...
DataNode DataNodeCreate(YDKStatePtr state, DataNode datanode, const char* path,
                        const char* value) {
  try {
    DataNodeWrapper* datanode_wrapper = (DataNodeWrapper*)datanode;
    ydk::path::DataNode* real_datanode = unwrap(datanode_wrapper);
...
DataNodeChildren DataNodeGetChildren(DataNode datanode) {
  ...
  if (real_datanode != nullptr) {
    std::vector<shared_ptr<ydk::path::DataNode>> children =
        real_datanode->get_children();
...
void YLogInfo(const char* msg) { YLOG_INFO(msg); }

void YLogDebug(const char* msg) { YLOG_DEBUG(msg); }

void YLogWarn(const char* msg) { YLOG_WARN(msg); }

void YLogError(const char* msg) { YLOG_ERROR(msg); }
