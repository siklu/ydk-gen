...
class NetworkTopology : public ydk::Entity {
 public:
  ...
  std::vector<std::pair<std::string, ydk::LeafData>> get_name_leaf_data()
      const override;
  std::string get_segment_path() const override;
  std::shared_ptr<ydk::Entity> get_child_by_name(
      const std::string& yang_name, const std::string& segment_path) override;
  void set_value(const std::string& value_path, const std::string& value,
                 const std::string& name_space,
                 const std::string& name_space_prefix) override;
  void set_filter(const std::string& value_path, ydk::YFilter yfliter) override;
  std::map<std::string, std::shared_ptr<ydk::Entity>> get_children()
      const override;
  ...
  std::vector<std::shared_ptr<
      opendaylight::network_topology::NetworkTopology::Topology>>
      topology;
...
class NetworkTopology::Topology : public ydk::Entity {
 public:
  ...
  std::vector<std::shared_ptr<
      opendaylight::network_topology::NetworkTopology::Topology::Link>>
      link;
  std::vector<std::shared_ptr<
      opendaylight::network_topology::NetworkTopology::Topology::Node>>
      node;
  std::shared_ptr<
      opendaylight::network_topology::NetworkTopology::Topology::TopologyTypes>
      topology_types;
  std::vector<std::shared_ptr<opendaylight::network_topology::NetworkTopology::
...
class NetworkTopology::Topology::TopologyTypes : public ydk::Entity {
 public:
  ...
  class
      TopologyNetconf;  // type:
                        // NetworkTopology::Topology::TopologyTypes::TopologyNetconf

  std::shared_ptr<opendaylight::network_topology::NetworkTopology::Topology::
                      TopologyTypes::TopologyNetconf>
      topology_netconf;

};  // NetworkTopology::Topology::TopologyTypes

class NetworkTopology::Topology::TopologyTypes::TopologyNetconf
    : public ydk::Entity {
 public:
  TopologyNetconf();
  ~TopologyNetconf();
...
class NetworkTopology::Topology::UnderlayTopology : public ydk::Entity {
 public:
  ...
  // type: string (refers to
  // opendaylight::network_topology::NetworkTopology::Topology::topology_id)
...
class NetworkTopology::Topology::Node : public ydk::Entity {
 public:
  ...
  std::shared_ptr<opendaylight::network_topology::NetworkTopology::Topology::
                      Node::ClusteredConnectionStatus>
      clustered_connection_status;
  std::shared_ptr<opendaylight::network_topology::NetworkTopology::Topology::
                      Node::PassThrough>
      pass_through;
  std::vector<std::shared_ptr<opendaylight::network_topology::NetworkTopology::
                                  Topology::Node::SupportingNode>>
      supporting_node;
  std::vector<std::shared_ptr<opendaylight::network_topology::NetworkTopology::
                                  Topology::Node::TerminationPoint>>
      termination_point;
  std::shared_ptr<opendaylight::network_topology::NetworkTopology::Topology::
                      Node::UnavailableCapabilities>
      unavailable_capabilities;
  std::shared_ptr<opendaylight::network_topology::NetworkTopology::Topology::
                      Node::YangLibrary>
      yang_library;
  std::shared_ptr<opendaylight::network_topology::NetworkTopology::Topology::
                      Node::YangModuleCapabilities>
...
class NetworkTopology::Topology::Node::SupportingNode : public ydk::Entity {
 public:
  ...
  ydk::YLeaf topology_ref;
  // type: string (refers to
  // opendaylight::network_topology::NetworkTopology::Topology::Node::node_id)
  ydk::YLeaf node_ref;
...
class NetworkTopology::Topology::Node::TerminationPoint : public ydk::Entity {
 public:
  ...
  // type: list of  string (refers to
  // opendaylight::network_topology::NetworkTopology::Topology::Node::TerminationPoint::tp_id)
  ydk::YLeafList tp_ref;

};  // NetworkTopology::Topology::Node::TerminationPoint

class NetworkTopology::Topology::Node::YangModuleCapabilities
    : public ydk::Entity {
 public:
...
class NetworkTopology::Topology::Node::ClusteredConnectionStatus
    : public ydk::Entity {
 public:
...
class NetworkTopology::Topology::Node::ClusteredConnectionStatus::NodeStatus
    : public ydk::Entity {
 public:
  NodeStatus();
  ~NodeStatus();
...
class NetworkTopology::Topology::Node::AvailableCapabilities
    : public ydk::Entity {
 public:
...
class NetworkTopology::Topology::Node::AvailableCapabilities::
    AvailableCapability : public ydk::Entity {
 public:
  AvailableCapability();
  ~AvailableCapability();
...
class NetworkTopology::Topology::Node::UnavailableCapabilities
    : public ydk::Entity {
 public:
...
class NetworkTopology::Topology::Node::UnavailableCapabilities::
    UnavailableCapability : public ydk::Entity {
 public:
...
class NetworkTopology::Topology::Link : public ydk::Entity {
 public:
  ...
  std::shared_ptr<opendaylight::network_topology::NetworkTopology::Topology::
      ...
      destination;
  std::shared_ptr<
      opendaylight::network_topology::NetworkTopology::Topology::Link::Source>
      source;
  std::vector<std::shared_ptr<opendaylight::network_topology::NetworkTopology::
                                  Topology::Link::SupportingLink>>
      supporting_link;
...
class NetworkTopology::Topology::Link::Destination : public ydk::Entity {
 public:
  ...
  // type: string (refers to
  // network_topology::NetworkTopology::Topology::Node::node_id)
  ydk::YLeaf dest_node;
  // type: string (refers to
  // network_topology::NetworkTopology::Topology::Node::TerminationPoint::tp_id)
  ydk::YLeaf dest_tp;
...
class NetworkTopology::Topology::Link::SupportingLink : public ydk::Entity {
 public:
  ...
  // type: string (refers to
  // opendaylight::network_topology::NetworkTopology::Topology::Link::link_id)
  ydk::YLeaf link_ref;
...
class NetworkTopology::Topology::Node::AvailableCapabilities::
    AvailableCapability::CapabilityOrigin : public ydk::Enum {
 public:
...
class NetworkTopology::Topology::Node::UnavailableCapabilities::
    UnavailableCapability::FailureReason : public ydk::Enum {
 public:
